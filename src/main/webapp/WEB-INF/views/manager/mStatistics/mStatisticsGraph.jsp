...
<html lang="en">
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="resources/css/mStatisticsGraph.css">
   </head>
   <body>
      <div class="container">
      ...
      <script>
         ...
         var myChart = new Chart(ctx, {
             ...
             data: {
                 ...
                 datasets: [{
                     label: '월 방문자', 
                     data: [${visitant1}, ${visitant2}, ${visitant3}, ${visitant4}, ${visitant5}, ${visitant6}, ${visitant7}, ${visitant8},
                    	    ${visitant9}, ${visitant10}, ${visitant11}, ${visitant12}],
