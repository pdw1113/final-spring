		...
		<form action="pInsert.do" role="form" method="post" autocomplete="off" id="success" enctype="multipart/form-data" >
			...
			<div class="input_div_addproduct">
				...
				<div class="status_div_addproduct">
					...
					<input type="text" maxlength="20" placeholder="제목 입력(20자 이내로 입력해주세요)" class="input_text_addproduct" name="title" id="title">
				</div>
				<!-- 카테고리 -->
				<div class="status_div_addproduct">
	                ...
	                <button type="button" class="cate_sub_btn" id="sub">제거</button>
	            </div>
