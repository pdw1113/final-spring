  ...
  <div class="all_wrapper">
    ...
    <div class="p2p_class_nav">
      <ul>
        ...
        <li>
          <a href="javascript:;">상품소개</a>
        </li>
        <li>
          <a href="javascript:;">SNS & 유튜브</a>
        </li>
        <li>
          <a href="javascript:;">환불규정</a>
        </li>
        <li>
          <a href="javascript:;">상품 구매자 리얼 댓글</a>
        </li>
      </ul>
    </div>
    <!-- ************************************* -->
    ...
    <div class="product_container">
      ...
      <section class="idx sec_common p2p_class_detail">
        ...
        <div class="p_col_right">
          ...
          <div>
            <div>
              <input class="youtube_show" type="hidden" value="https://www.youtube.com/watch?v=9-VLWHAWAmE">
              <div>
              </div>
            </div>
            <div>
              <input class="youtube_show" type="hidden" value="https://www.youtube.com/watch?v=JDpIMnKtHXw">
              <div>
              </div>
            </div>
            <div>
              <input class="youtube_show" type="hidden" value="https://www.youtube.com/watch?v=7y7g5j2Z9NM">
              <div>
              </div>
            </div>
          </div>
      ...
      <section class="idx sec_common p2p_class_cmt" id="review">
        ...
        <div class="p_col_right">
          ...
          <div class="inputReview">
            ...
            <button id="cmt_btn">댓글<br>작성</button>
          </div>
          <!-- 댓글 영역 -->
    ...
    <div class="sticky_area" id="sticky">
      <div class="sticky_navi">
        ...
        <ul class="p_flex">
          <li>구매 시간</li>
          <li class="number_change">
            <i class="fas fa-angle-left detail_btn"></i>
            <span>1</span>
            <i class="fas fa-angle-right detail_btn"></i>
          </li>
          <li>시간</li>
        </ul>
        <ul class="p_flex">
