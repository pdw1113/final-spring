...
//		
//		// JSON(보낸 사람, 메세지) => Map으로 변환, {"roomId" : "n01", "email":"cheon@gmail.com","message":"qwg"}
//		ObjectMapper objectMapper = new ObjectMapper();
//		Map<String, String> mapReceive = objectMapper.readValue((String)message.getPayload(), Map.class);
//
//		// 모든 세션에 뿌려주기
//		for(WebSocketSession s : sessionSet) {
//			s.sendMessage(new TextMessage(mapReceive.get("email") + "," +  mapReceive.get("message")));
//		}
//		
//		// 방번호, 작성자, 메세지
//		System.out.println("방번호 : " + mapReceive.get("roomId"));
//		System.out.println("작성자 : " + mapReceive.get("email"));
//		System.out.println("메세지 : " + mapReceive.get("message"));
//	}
//
//	/**
//	 * 전송 에러 발생할 때 호출
